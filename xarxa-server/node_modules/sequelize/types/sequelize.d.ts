import { HookReturn, Hooks, SequelizeHooks } from 'sequelize/types/hooks';
...
import { QueryInterface, QueryOptions, QueryOptionsWithModel, QueryOptionsWithType, ColumnsDescription } from 'sequelize/types/dialects/abstract/query-interface';
...
import { Cast, Col, DeepWriteable, Fn, Json, Literal, Where } from 'sequelize/types/utils';
